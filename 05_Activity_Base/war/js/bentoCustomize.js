...
/*
* This file contains the backend process for the 'Customize Bento' screen
* that is under the 'bentoController'.
...
app.controller('bentoController', function($scope) {
	console.log("bentoCustomize.bentoController " + "start");
